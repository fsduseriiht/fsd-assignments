...
public class Main_10_Spring_Assignment1 {
	...
	public static void main(String[] args) {
		...
		Main_10_Spring_Assignment1 mainObj = new Main_10_Spring_Assignment1();
	...
	private void addBook(BufferedReader buffer) {
		...
		Book newBook = (Book) context.getBean("book");
		long bookId;
		String title;
		double price;
		int volume;
	...
	private void addSubject(BufferedReader buffer) {
		...
		List<Subject> allSubjects;
		// TODO: 
		Subject newSubject = (Subject) context.getBean("subject");
		long subjectId;
		String subtitle;
		int durationInHours;
		Set<Book> references;
