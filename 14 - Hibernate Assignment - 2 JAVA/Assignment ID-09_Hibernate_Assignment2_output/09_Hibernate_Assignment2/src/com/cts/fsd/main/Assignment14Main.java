...
import com.cts.fsd.controller.AppController;
...
//						subjectDTO = UserController.getSubjectDetailsFromUser(buffer);
				...
				case "c":
					ApplicationUtility.displayOptionReceived(inputStr);
					{
						...
						if (null != subjectDTO) {
							AppController.deleteSubject(subjectDTO);
						}
					}
					break;
				...
				case "d":
					ApplicationUtility.displayOptionReceived(inputStr);
					{
						...
						if (null != bookDTO) {
							AppController.deleteBook(bookDTO);
						}
					}
					break;
				...
				case "e":
					ApplicationUtility.displayOptionReceived(inputStr);
					{
						...
						if (null != searchMap && !searchMap.isEmpty()) {
							List<BookDTO> bookDTOList = AppController.searchBook(searchMap);
