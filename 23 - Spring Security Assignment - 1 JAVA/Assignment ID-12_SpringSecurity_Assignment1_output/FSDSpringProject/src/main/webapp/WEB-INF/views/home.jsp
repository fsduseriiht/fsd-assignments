...
<body>
	...
	<!-- <center> -->
		...
		<table>
			...
			<!-- =========================		   PRINCIPAL       ====================== -->
			<!-- ======================================================================== -->
			<c:if test = "${userdetails.type eq 'ADMIN'}"> <!-- PRINCIPAL -->
				<tr>
					<td>a:</td>
					<td colspan="2" >
			...
			<!-- =========================		LIBRARIAN		====================== -->
			<!-- ======================================================================== -->
			<c:if test = "${userdetails.type eq 'USER'}"> <!-- LIBRARIAN -->
				<tr>
					<td>a:</td>
					<td colspan="2" >
			...
			<tr>
				...
				<td colspan="2" >
					...
					<a href="${pageContext.request.contextPath}/logout" >Exit Application</a>
				</td>
			</tr>
